...
const ReactTab = () => {
  const { regulerCar, sportsCar, trucks, data ,   handle_react_tab} = useContext(AuthContext);
  ...
  return (
    <Container>
      <div className={!data?'d-flex justify-content-center align-items-center my-5 py-5':'d-none'}>
