...
const ExtraSection2 = () => {
    return (
        <div className='my-5'>
            <Container>
                <div className="row">
                    <div className="col-12 d-flex justify-content-center align-items-center col-md-6"><img className='img-fluid rounded' src="https://3dprint.com/wp-content/uploads/2015/05/bugatti6.jpg" alt="" /></div>
